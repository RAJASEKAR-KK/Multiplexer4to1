...
```
# Output:
![Multiplexer 4 to 1](https://github.com/RESMIRNAIR/Multiplexer4to1/assets/165815233/6303a7b1-814b-4f96-ad3e-faf6fb86f0fa)

# Result:
Hence the Multiplexer 4 to 1 is verified successfully.
